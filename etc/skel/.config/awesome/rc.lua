...
globalkeys = my_table.join(
    ...
    -- Kiro propagated bindings (from ohmychadwm master)
    awful.key({ modkey }, "KP_Enter", function() awful.util.spawn("alacritty") end,
        {description = "alacritty", group = "Kiro"}),
    awful.key({ modkey, "Shift" }, "Escape", function() awful.util.spawn("xkill") end,
        {description = "xkill", group = "Kiro"}),
    awful.key({ modkey, "Shift" }, "KP_Enter", function() awful.util.spawn("thunar") end,
        {description = "thunar", group = "Kiro"}),
    awful.key({ modkey1, altkey }, "q", function() awful.util.spawn("alacritty-tweak-tool") end,
        {description = "alacritty-tweak-tool", group = "Kiro"}),
    awful.key({ modkey1, altkey }, "comma", function() awful.util.spawn("mintstick -m iso") end,
        {description = "mintstick", group = "Kiro"}),
    awful.key({ altkey }, "r", function() awful.util.spawn("rofi-theme-selector") end,
        {description = "rofi-theme-selector", group = "Kiro"}),
    awful.key({ modkey1, altkey }, "z", function() awful.util.spawn("fastfetch-tweak-tool") end,
        {description = "fastfetch-tweak-tool", group = "Kiro"}),
    awful.key({ modkey1, altkey }, "w", function() awful.util.spawn("fastfetch-tweak-tool") end,
        {description = "fastfetch-tweak-tool", group = "Kiro"}),
    awful.key({ modkey1, altkey }, "r", function() awful.util.spawn("archlinux-betterlockscreen") end,
        {description = "archlinux-betterlockscreen", group = "Kiro"}),
    awful.key({ modkey, modkey1 }, "space", function() awful.util.spawn("variety --selector") end,
        {description = "wallpaper selector", group = "Kiro"}),
    awful.key({ modkey1, altkey }, "End", function() awful.util.spawn("alacritty -e btop") end,
        {description = "btop", group = "Kiro"}),
    awful.key({ modkey, modkey1 }, "Print", function() awful.util.spawn("flameshot gui") end,
    ...
    -- Function keys
    awful.key({ }, "F12", function () awful.util.spawn( "alacritty" ) end,
    ...
    awful.key({ modkey, "Shift"   }, "x",  function () awful.util.spawn( "edu-powermenu" ) end,
      {description = "exit", group = "hotkeys"}),
    ...
    awful.key({ modkey1, altkey   }, "a", function() awful.util.spawn( "alacritty-tweak-tool" ) end,
        {description = "alacritty-tweak-tool", group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "b", function() awful.util.spawn( "brave --password-store=basic" ) end,
        {description = "brave", group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "c", function() awful.util.spawn("chromium -no-default-browser-check") end,
    ...
    awful.key({ modkey1, altkey   }, "l", function() awful.util.spawn( "archlinux-logout --settings" ) end,
        {description = scrlocker, group = "alt+ctrl"}),
    awful.key({ modkey }, "g", function() awful.spawn.with_shell("$HOME/.config/awesome/scripts/fastcompmgr-toggle.sh") end,
        {description = "Compositor toggle", group = "super"}),
    awful.key({ modkey1, altkey   }, "s", function() awful.util.spawn( "fish-tweak-tool" ) end,
        {description = "fish-tweak-tool", group = "alt+ctrl"}),
    ...
    awful.key({ modkey1, altkey   }, "Return", function() awful.util.spawn(terminal) end,
        {description = terminal, group = "alt+ctrl"}),
    awful.key({ modkey1, altkey   }, "m", function() awful.util.spawn( "mintstick -m iso" ) end,
        {description = "mintstick", group = "alt+ctrl"}),
    ...
    awful.key({ altkey }, "Right", function () awful.util.spawn( "variety -n" ) end,
        {description = "Wallpaper next", group = "altkey"}),
    awful.key({ altkey }, "Up", function () awful.util.spawn( "variety --toggle-pause" ) end,
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'Kiro-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
